...
public class BuyItems : MonoBehaviour
{
    ...
    public void BuyItem()
    {
        ...
        if (moneyManager.Buy((int)itemCost))
        {
            ...
            if (itemIconPrefab != null && backpackPanel != null)
            {
            ...
            else if (itemIconPrefab != null)
            {
                // Instantiate the item icon wherever you want it to appear
                Instantiate(itemIconPrefab);
            }
